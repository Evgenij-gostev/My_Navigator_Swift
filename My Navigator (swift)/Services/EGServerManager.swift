...
class EGServerManager {
  ...
  func getRouteWithOrigin(_ origin: CLLocationCoordinate2D,
    ...
    urlComponents.queryItems = [
      NSURLQueryItem(name: "origin", value: String(origin.latitude) + "," + String(origin.longitude)),
      NSURLQueryItem(name: "destination", value: String(destination.latitude) + "," + String(destination.longitude)),
      ...
      NSURLQueryItem(name: "key", value: String("AIzaSyDbPMpz5YN6DbntQcX6XN3mwSee-HeRHIQ"))
      ] as [URLQueryItem]
...
//        print(json)
  ...
  func getAddressForCoordinate(_ coordinate: CLLocationCoordinate2D,
    ...
    urlComponents.queryItems = [
      NSURLQueryItem(name: "latlng", value: String(coordinate.latitude) + "," + String(coordinate.longitude)),
      NSURLQueryItem(name: "key", value: String("AIzaSyAuzyI7se6hI1jNVS_V-RRZlVEW3AXZNsE"))
      ] as [URLQueryItem]
